"""
Django settings for it_shoe project.
...
SECRET_KEY = "django-insecure-=ryb_3sonr^i+o-irp#n%mbzho!tyh4m1%x@1itqx9^mm$#g5s"
...
WSGI_APPLICATION = "it_shoe.wsgi.application"
